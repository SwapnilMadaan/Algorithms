...
public:
    ...
    //~Graph);
	void addEdgeWieght(int i, int j, int cost);
...
void Graph::addEdgeWieght(int i, int j, int cost) {
...
int main(){
	Graph g(5);
	g.addEdgeWieght(0, 1, 10); 
	g.addEdgeWieght(0, 3, 5);
	g.addEdgeWieght(1, 2, 1);  
	g.addEdgeWieght(1, 3, 2);
	g.addEdgeWieght(2, 4, 4);
	g.addEdgeWieght(3, 1, 3);  
	g.addEdgeWieght(3, 2, 9);
	g.addEdgeWieght(3, 4, 2);
	g.addEdgeWieght(4, 0, 7);  
	g.addEdgeWieght(4, 2, 6);
